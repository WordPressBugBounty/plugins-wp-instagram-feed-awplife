jQuery(window).load(function() {
    jQuery(function($) {
        ...
        var showModal = function(that) {
            ...
            var username = (rawData.username && rawData.username !== 'undefined' && rawData.username !== '') ? rawData.username : ifgp_lightbox_vars.unknown_user;
            var imagedate = (rawData.imagedate && rawData.imagedate !== 'undefined' && rawData.imagedate !== '') ? rawData.imagedate : ifgp_lightbox_vars.recently;
            var imagetext = (rawData.imagetext && rawData.imagetext !== 'undefined' && rawData.imagetext !== '') ? rawData.imagetext : ifgp_lightbox_vars.no_caption;
            ...
            var tags = (imagetext && imagetext !== ifgp_lightbox_vars.no_caption) ? imagetext.split('#') : [ifgp_lightbox_vars.no_caption];
            ...
            if (jQuery('.carouselGallery-wrapper').length === 0) {
                if (typeof imagepath !== 'undefined' && imagepath !== '' && imagepath !== null) {
                    ...
                    modalHtml += "<span class='carouselGallery-left instagram-nav-arrow' title='" + ifgp_lightbox_vars.previous + "'><svg width='20' height='20' viewBox='0 0 24 24' fill='none'><path d='M15 18l-6-6 6-6' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/></svg></span>";
                    modalHtml += "<span class='carouselGallery-right instagram-nav-arrow' title='" + ifgp_lightbox_vars.next + "'><svg width='20' height='20' viewBox='0 0 24 24' fill='none'><path d='M9 18l6-6-6-6' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/></svg></span>";
                    modalHtml += "<span class='instagram-close-btn' title='" + ifgp_lightbox_vars.close + "'>&times;</span>";
                    ...
                    if (that[0].attributes[1].value == 'VIDEO') {
                        ...
                        modalHtml += "<img class='instagram-media' src='" + imagepath + "' alt='" + ifgp_lightbox_vars.instagram_image + "'>";
                    }
                    modalHtml += "</div>";
                    ...
                    modalHtml += "<img src='" + ifgp_lightbox_vars.plugin_url + "img/insta-icon.png' alt='User Avatar'>";
                    modalHtml += "</div>";
                    ...
                    modalHtml += "<a href='https://www.instagram.com/" + username + "' target='_blank' class='instagram-follow-link'>" + ifgp_lightbox_vars.follow + "</a>";
                    modalHtml += "</div>";
                    modalHtml += "</div>";
