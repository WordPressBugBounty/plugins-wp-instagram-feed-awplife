	...
	<div class="row">
		<div class="col-md-10">
			<div class="postbox-container insta-settings" style="margin-top:20px; margin-bottom:20px;">
				<div class="postbox">
					<div class="postbox-header"><h2 class="hndle ui-sortable-handle"><?php esc_html_e('Add Instagram Feed Gallery', 'wp-instagram-feed-awplife'); ?></h2>
						...
						<div class="d-flex align-items-start bhoechie-tab-container">
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
								<div class="list-group">
									<a href="#" class="list-group-item active">
										<span class="dashicons dashicons-instagram"></span><?php esc_html_e('Instagram Tocken', 'wp-instagram-feed-awplife'); ?>
									</a>
							...
							<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 bhoechie-tab">
								<div class="bhoechie-tab-content active">
									<h2><?php esc_html_e('Type Instagram Accese Tocken', 'wp-instagram-feed-awplife'); ?></h2>
									<hr>
									<div class="row">
										<div class="col-md-4">
											<div class="ma_field_discription">
												<h4><?php esc_html_e('Instagram Accese Tocken', 'wp-instagram-feed-awplife'); ?></h4>
								...
								<div class="bhoechie-tab-content">
									<h1><?php esc_html_e( 'Upgrade To Pro', 'wp-instagram-feed-awplife' ); ?></h1>
									<hr>
									<div style="padding-left: 10px;">
										<p class="ms-title"><?php esc_html_e( 'Upgrade To Premium For Unloack More Features & Settings', 'wp-instagram-feed-awplife' ); ?></p>
									</div>
									<div>
						...
						<div class="panel panel-info igp_pannel_bottom ">
							<div class="row panel-body notice notice-info notice-alt">
								<div class="col-md-6 text-left">
									<h3 class="panel-title"><?php esc_html_e('Instagram Feed Gallery Premium', 'wp-instagram-feed-awplife'); ?> <span style="display:inline;"><?php esc_html_e('Version', 'wp-instagram-feed-awplife'); ?> - <?php echo esc_html(IFGP_PLUGIN_VER); ?><span></h3>
								</div>
								<div class="col-md-6 text-right">
									<div class="panel-heading">
										<button type="button" onclick="IgpGetShortcode();" class="igp_button btn-lg button_1"><?php esc_html_e('[ Generate Sortcode ]', 'wp-instagram-feed-awplife'); ?></button>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="modal-dialog" role="document" id="inner-modal">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="modal-new-ticket-label"><?php esc_html_e('Instagram Feed Gallery Premium Shortcode', 'wp-instagram-feed-awplife'); ?></h4>
									</div>
									<div class="modal-body text-center">
										<textarea id="awl-shortcode" readonly rows="13" cols="120" style="width: 100%; font-size: 15px;">
										</textarea>
										<div class="center-block text-center">
											<button type="button" class="igp_button button_1" data-toggle="tooltip" title="Copied" onclick="CopyShortcode()" ><i class="fa fa-copy" aria-hidden="true"></i> <?php esc_html_e('Copy Sortcode', 'wp-instagram-feed-awplife'); ?></button>
										</div>
									</div>
								</div>
							</div>
